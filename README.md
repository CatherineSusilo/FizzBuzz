...
- [v] Open [`src/lab1/FizzBuzz.java`](src/lab1/FizzBuzz.java) and click the run button in the top left corner to run `FizzBuzz` to check your answer.
...
- [v] Make note of any specific Java syntax which stands out to you; then compare your observations
